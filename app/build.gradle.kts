...
android { namespace = "jp.okusuri.nonda"; compileSdk = 35
    defaultConfig { applicationId = "jp.okusuri.nonda"; minSdk = 26; targetSdk = 35; versionCode = 4; versionName = "1.2.1"; testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner" }
    signingConfigs {
